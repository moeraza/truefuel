...
const SEED_PRODUCTS: Product[] = [
  {
    ...
    slug: "gel-flask-150",
    description: "Reusable, BPA-free soft flask. Fits 100g of carbs (4 gel servings). Lock-top bite valve for clean, one-handed fueling on the move.",
    longDescription: "Built for runners who refuse single-use waste. This 150ml soft flask holds up to 100g of carbs in a single fill — that's 4 gel servings worth of fuel. Made from durable, food-grade TPU with a lock-top bite valve — squeeze and sip without breaking stride. Sized to fit any running vest pocket or shorts flask holder. Dishwasher safe. One flask replaces hundreds of single-use gel packets over its lifetime.\n\nFeatures:\n- 150ml capacity (up to 100g carbs / 4 servings)\n- BPA-free, food-grade TPU\n- Lock-top bite valve prevents leaks\n- Fits standard vest pockets\n- Dishwasher safe\n- Graduated markings for easy filling",
    price: 15.00,
    originalPrice: 20.00,
